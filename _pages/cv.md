...
<div class="cv-shell">
  ...
  <div class="cv-content">
    ...
    <details class="cv-card" id="about-me" open>
      ...
      <div class="cv-entry">
        ...
        <p class="cv-entry-detail">Current research: enhancing robotic gripper-mediated human-robot interaction with strain-gauge force sensors, covering mechanical structure design, embedded sensing/control systems, and force-feedback algorithms.</p>
      </div>
    </details>
    ...
    <details class="cv-card" id="education" open>
      ...
      <div class="cv-entry">
        <div class="cv-entry-header">
          <div class="cv-entry-title">M.Eng. in Computer Technology</div>
    ...
    <details class="cv-card" id="projects" open>
      ...
      <div class="cv-entry">
        ...
        <div class="cv-entry-title">Edge AI Voice Interaction Hardware Selection, Model Training, and Deployment</div>
        <ul class="cv-list">
          <li>Speech recognition system based on the Rockchip RK3588 and ReSpeaker Mic Array v2.0.</li>
        </ul>
    ...
    <details class="cv-card" id="experience" open>
      ...
      <div class="cv-entry">
        <div class="cv-entry-header">
          <div class="cv-entry-title">Edge AI Voice Interaction Hardware Selection, Model Training, and Deployment</div>
          <div class="cv-entry-date">Jul. 2025 - Sep. 2025</div>
        </div>
        <p class="cv-entry-meta">Project with Prof. <a href="https://sites.google.com/site/shaohuilin007" target="_blank" rel="external nofollow noopener">Shaohui Lin</a>'s <a href="https://eic-lab.github.io/" target="_blank" rel="external nofollow noopener">EIC Lab: Edge Intelligent Computing Lab</a>, East China Normal University, Shanghai, China</p>
        <ul class="cv-list">
          <li>(2025.9) Added touchscreen interaction support and validated touchscreen driver and click-input functionality for the embedded voice interaction device.</li>
          <li>(2025.8) Completed the first version of the local speech recognition system, supporting speaker verification and command recognition with the RK3588 and ReSpeaker Mic Array v2.0 platform.</li>
          <li>(2025.7) Started hardware platform selection for edge AI voice interaction, evaluating the RK3588-based edge computing platform, audio front-end hardware, and embedded system integration requirements.</li>
        </ul>
      </div>
      <div class="cv-entry">
        <div class="cv-entry-header">
      ...
      <div class="cv-entry">
        <div class="cv-entry-header">
          <div class="cv-entry-title">FPGA Engineering Intern</div>
          <div class="cv-entry-date">Apr. 2023 - Aug. 2023</div>
        </div>
        <p class="cv-entry-meta">Intel China Innovation Center</p>
        <ul class="cv-list">
          <li>Developed FPGA-based implementations of the LeNet-5 neural network accelerator.</li>
          <li>Participated in multiple computer vision projects, including handwritten digit recognition and face mask detection.</li>
          <li>Implemented and optimized FPGA acceleration algorithms for deep learning applications.</li>
          <li>Collaborated with team members throughout project development and evaluation.</li>
          <li>Ranked first in the final evaluation among participating teams.</li>
        </ul>
      </div>
      <div class="cv-entry">
        <div class="cv-entry-header">
          <div class="cv-entry-title">Research Assistant</div>
          <div class="cv-entry-date">Aug. 2022 - Mar. 2023</div>
        </div>
        <p class="cv-entry-meta">Lingyou Technology Co., LTD.</p>
        <ul class="cv-list">
          <li>Designed capacitive touchscreen circuits for laser rangefinder products.</li>
          <li>Developed PCB schematics and layouts using Altium Designer.</li>
          <li>Designed mechanical enclosures with SolidWorks based on product requirements.</li>
          <li>Participated in motor control system design and hardware integration.</li>
          <li>Maintained programming servers and provided daily technical support.</li>
          <li>Organized and coordinated student internship teams for engineering projects.</li>
        </ul>
      </div>
    </details>
